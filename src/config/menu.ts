...
export const skills = [
  ['React.js', 'Next.js', 'Vue.js', 'Angular.js', 'Three.js', 'TailwindCSS', 'MaterialUI', 'Bootstrap', 'UI/UX Design', 'Sass', 'ESLint'],
  ['Node.js', 'Express.js', 'Nest.js', 'PHP', 'Python', "MongoDB", 'MySQL', 'GraphQL', 'Firebase', 'AWS', 'Azure'],
  ['Rust', 'Solidity', 'Typescript', '.NET', 'Java', 'Ruby on Rail', 'C++', 'C#'],
  ['Smart Contact', 'Secret', 'Crypto games', 'Web3', 'Cross-chain', 'DeFi', 'Trading App'],
...
export const projects = [
  ...
  
  {
    ...
    title: '$Bmp brc-20',
    description:
      '$bmp token(Bitcoin BRC-20) airdrop platform to',
    stack: ['React', 'Brc-20'],
    image: '/img/3.png',
    links: [
  ...
  },
  {
    ...
    title: 'Satoshi Punks',
    description:
      'Ordinal raffle platform in Bitcoin Network.',
  ...
  },
  {
    ...
    title: 'Bitcoin Defi',
    description:
      'ArcusLab is a cutting-edge Bitcoin DeFi platform',
